    ...
    if (results > 0) {
      ...
      return context.dataSubscriberRepository.getDataSubscribers('by_dataSubscriber').then(function(dataSubscribers) {
        ...
        if (validatename < 1) {
          ...
          return context.dataSubscriberRepository.insert(dataSubscriber).then(function(value) {
            return value;
...
dataSubscriberService.prototype.updateDataSubscriber = function(dataSubscriberData) {
  ...
  return context.dataSubscriberRepository.getDataSubscribers('by_dataSubscriber').then(function(dataSubscribers) {
    ...
    if (validatename < 1) {
      ...
      return context.dataSubscriberRepository.getDataSubscriber(updated.data.id).then(function(original) {
