    ...
    if (results > 0) {
      ...
      return context.AgencyRepository.getAgencies().then(function(agencies) {
        ...
        if (validatename < 1) {
          ...
          return context.AgencyRepository.insert(agency, attachments).then(function(value) {
            return value;
...
AgencyService.prototype.updateAgency = function(agencyData, attachments) {
  ...
  return context.AgencyRepository.getAgencies().then(function(agencies) {
    ...
    if (validatename < 1) {
      ...
      return context.AgencyRepository.getAgency(updated.data.id).then(function(original) {
