...
(function () {
    ...
    var d = {}, e = {}, f = {}, g = {omitExtraWLInCodeBlocks: !1, prefixHeaderId: !1};
    d.helper = {}, d.extensions = {}, d.setOption = function (a, b) {
        ...
        a = a || {};
        var j = {}, k = [], l = [], m = ["githubCodeBlocks", "hashHTMLBlocks", "stripLinkDefinitions", "blockGamut", "unescapeSpecialChars"];
        for (var n in g)g.hasOwnProperty(n) && (j[n] = g[n]);
        if ("object" == typeof a)for (var o in a)a.hasOwnProperty(o) && (j[o] = a[o]);
        var p = this;
        ...
        }), {makeHtml: b, setOption: c, getOption: h, getOptions: i}
        ...
        return a = a.replace(/^(.+)[ \t]*\n=+[ \t]*\n+/gm, function (a, f) {
            var g = d.subParser("spanGamut")(f, b, c), h = '<h1 id="' + e(f) + '">' + g + "</h1>";
            return d.subParser("hashBlock")(h, b, c)
        }), a = a.replace(/^(.+)[ \t]*\n-+[ \t]*\n+/gm, function (a, f) {
            var g = d.subParser("spanGamut")(f, b, c), h = '<h2 id="' + e(f) + '">' + g + "</h2>";
            return d.subParser("hashBlock")(h, b, c)
        }), a = a.replace(/^(\#{1,6})[ \t]*(.+?)[ \t]*\#*\n+/gm, function (a, f, g) {
            var h = d.subParser("spanGamut")(g, b, c), i = "<h" + f.length + ' id="' + e(g) + '">' + h + "</h" + f.length + ">";
        ...
        var e = function (a, b, e, f, g, h, i, j) {
            a = b;
            var k = e, l = f.toLowerCase(), m = g, n = j, o = c.gUrls, p = c.gTitles;
            if (n || (n = ""), "" === m || null === m) {
